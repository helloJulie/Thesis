...
The primary objective is to construct a portfolio that maximizes return for a given level of risk or minimizes risk for a given return, using historical data.
